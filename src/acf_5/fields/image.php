...
if($this->acf5_current_version() < 5.6) {
    class acf_qtranslate_acf_5_image_dynamic extends acf_field_image {}
} else {
    class acf_qtranslate_acf_5_image_dynamic extends acf_field {}
}

class acf_qtranslate_acf_5_image extends acf_qtranslate_acf_5_image_dynamic {
