...
if($this->acf5_current_version() < 5.6) {
    class acf_qtranslate_acf_5_wysiwyg_dynamic extends acf_field_wysiwyg {}
} else {
    class acf_qtranslate_acf_5_wysiwyg_dynamic extends acf_field {}
}

class acf_qtranslate_acf_5_wysiwyg extends acf_qtranslate_acf_5_wysiwyg_dynamic {
